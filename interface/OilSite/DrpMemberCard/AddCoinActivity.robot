...
give_coin_limited_times
    ...
    #新建充值活动
    ${res}=     pc interface post      ${DrpMemberCardAddCoinActivityUrl}   {"name": "${MemberCardAddCoinActivityName}", "start_time": "${start_time}", "end_time": "${end_time}", "discount_type": "1", "max_count": "1", "status": "1", "activity_type": "0", "activity_item": "[{\\"amt\\":\\"1\\",\\"zs_value\\":\\"1\\",\\"max_count\\":0}]", "coupon_item": "[{\\"amt\\":\\"\\",\\"coupon_id\\":\\"\\",\\"num\\":\\"\\"}]"}   ${PcHeader}
    should contain      ${res}      "code":1,
    ...
    ${active_id}    set variable    ${dic}[data][item][activity_id]
    ${give_amt}     set variable    ${dic}[data][item][zs_value]
    should be equal as numbers    ${give_amt}     0
...
give_coin_limited_times_item
    ...
    #新建充值活动
    ${res}=     pc interface post      ${DrpMemberCardAddCoinActivityUrl}   {"name": "${MemberCardAddCoinActivityName}", "start_time": "${start_time}", "end_time": "${end_time}", "discount_type": "1", "max_count": "0", "status": "1", "activity_type": "0", "activity_item": "[{\\"amt\\":\\"1\\",\\"zs_value\\":\\"1\\",\\"max_count\\":1}]", "coupon_item": "[{\\"amt\\":\\"\\",\\"coupon_id\\":\\"\\",\\"num\\":\\"\\"}]"}   ${PcHeader}
    should contain      ${res}      "code":1,
...
give_coin_limited_times_item_twice
    ${header}=      read config     header
    ${PcHeader}=    read config     PcHeader
    ${user_id}=     getUserId
    ...
    #新建充值活动
    ${res}=     pc interface post      ${DrpMemberCardAddCoinActivityUrl}   {"name": "${MemberCardAddCoinActivityName}", "start_time": "${start_time}", "end_time": "${end_time}", "discount_type": "1", "max_count": "0", "status": "1", "activity_type": "0", "activity_item": "[{\\"amt\\":\\"1\\",\\"zs_value\\":\\"1\\",\\"max_count\\":2}]", "coupon_item": "[{\\"amt\\":\\"\\",\\"coupon_id\\":\\"\\",\\"num\\":\\"\\"}]"}   ${PcHeader}
    should contain      ${res}      "code":1,
    ...
    ${active_id}    set variable    ${dic}[data][item][activity_id]
    ${give_amt}     set variable    ${dic}[data][item][zs_value]
    should be equal as numbers    ${give_amt}     1
...
give_coupon_threshold_below_first
    ${header}=      read config     header
    ${PcHeader}=    read config     PcHeader
    ${user_id}=     getUserId
    ...
    #卡列表充值
    ${res}=     pc interface post      ${DrpMemberOffLineAddCoinOrderUrl}   {"user_id": "${user_id}", "org_amt": "${org_amt}", "active_id": "0", "note": "", "pay_method_id": "1"}   ${PcHeader}
    should contain      ${res}      "code":1,
    ...
    ${coin_balance_change}=     evaluate  ${coin_balance_after}-${coin_balance_before}
    should be equal as numbers    ${coin_balance_change}    ${org_amt}
...
give_coupon_threshold_between_1_2
    ${header}=      read config     header
    ${PcHeader}=    read config     PcHeader
    ${user_id}=     getUserId
...
give_coupon_threshold_two_same_item
    ${header}=      read config     header
    ${PcHeader}=    read config     PcHeader
    ${user_id}=     getUserId
    ...
    #新建充值活动
    ${res}=     pc interface post      ${DrpMemberCardAddCoinActivityUrl}   {"name": "${MemberCardAddCoinActivityName}", "start_time": "${start_time}", "end_time": "${end_time}", "discount_type": "1", "max_count": "0", "status": "1", "activity_type": "1", "activity_item": "[{\\"amt\\":\\"\\",\\"zs_value\\":\\"\\",\\"max_count\\":0}]", "coupon_item": "[{\\"amt\\":\\"1\\",\\"coupon_id\\":651,\\"num\\":\\"1\\"},{\\"amt\\":\\"1\\",\\"coupon_id\\":652,\\"num\\":\\"1\\"},{\\"amt\\":\\"3\\",\\"coupon_id\\":652,\\"num\\":\\"3\\"}]"}   ${PcHeader}
    should contain      ${res}      "code":1,
    ...
    ${coupon_num_change}=   evaluate  ${coupon_num_after}-${coupon_num_before}
    should be equal as numbers      ${coupon_num_change}        2
